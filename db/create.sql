...
CREATE TABLE Products (
    ...
    FOREIGN KEY (seller_id) REFERENCES Users(id) CHECK (SELECT isSeller FROM Users WHERE id = seller_id)
...
>>>>>>> parent of f6549ef (finishing generate for lineitem, ordersinprogress, and cart. also added some more functionality to cart)
